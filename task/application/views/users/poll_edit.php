...
<div class="row">
    <div class="col-sm-9 col-sm-offset-3 col-md-6 col-md-offset-2 main">
        ...
        <?= form_open_multipart('polls/edit/' . $poll['poll_id'], array('class' => 'form-horizontal')) ?>
        <div class="form-group">
            <label class="control-label col-sm-4">Vote Title</label>
            <input class="form-control " name="poll_title"
                   value="<?= set_value('poll_title', $poll['poll_title']) ?>"/>
        ...
        <input type="checkbox" name="poll_state" id="chk1" value="1" <?php echo set_checkbox("poll_state", "1", ($poll['poll_state'] == 1) ? TRUE : FALSE); ?> />
        <br />

        <input class="btn btn-primary" type="submit" name="save" value="Edit Poll"/>
